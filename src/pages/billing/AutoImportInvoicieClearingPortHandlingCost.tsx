...
const ItemData = [
    {
        ...
        ItemUrl: "htttp/jjnkkukjajjnkkukja",
        ItemCost: "$88.99",
        ItemQuantity: "3",
        TotalValue: "$112.49"
    }, {
...
const AutoImportInvoicieClearingPortHandlingCost = () => {
            ...
            <div
                ...
                <div
                    ...
                    <div className="text-[28px] text-[#6750A4]">
                        Invoice - Clearing & Port Handling Cost     
                    </div>
                ...
                <div
                    ...
                    <div className="flex">
                        <div className="text-[28px] max-sm:text-[22px] text-[#1C1B1F]">Order ID:</div>
                ...
                <div className="flex justify-between max-sm:flex-col mt-[10px]">
                    ...
                    <div
                        className="flex h-[173px] w-[345px] max-sm:w-full flex-col max-sm:items-end max-sm:my-[20px]">
                        {/* // w-[345px] */}
                        ...
                        <div className="flex flex-col">
                         ...
                         <div
                            ...
                            <>
                                    ...
                                    ItemData.map((item) => {
                                        return <div
                                                    className="flex items-center justify-between bg-white pb-[20px] mx-[20px] my-[20px] border-b">
                                                    <div className="flex">
                                                        <div className="flex w-[231.54px] me-[10px]">
                                                            <img className="me-[10px]" src={`/images/${item?.ItemSrc}.svg`}></img>
                                                            <div>
                                                                {item?.Item}
                                                            </div>
                                                        </div>
                                                        <div className="w-[54px] ms-[5px]">{item?.ItemCost}</div>
                                                    </div>
...
export default AutoImportInvoicieClearingPortHandlingCost;
