...
const InvoiceShopForMeShippingCost = () => {
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div className="flex h-[25px] w-[25px] items-center justify-center">
                                    <input type="radio" className="radio-group opacity-0.38 h-4 w-4"></input>
                                </div>
                                <p className="text-[14px] font-[500] ml-1">Basic</p>
                            </div>
                            <div
                                ...
                                <>
                                    ...
                                    ItemData.map((item) => {
                                        return <div
                                                    ...
                                                    <div className="w-[150px] break-words underline text-blue-400">
                                                        {item?.ItemUrl}
                                                    </div>
...
export default InvoiceShopForMeShippingCost;
